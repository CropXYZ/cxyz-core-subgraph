...
import {
  MintedPlotAdmin,
  MintedPlotPackActivate,
  Paused,
  Unpaused
} from "../generated/PlotCore/PlotCore";
...
export function handleMintActivate(event: MintedPlotPackActivate): void {
...
export function handleMintAdmin(event: MintedPlotAdmin): void {
  const plot = new Plot(event.params.id.toString());
